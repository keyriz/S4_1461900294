    ...
    <div class="min-w-screen min-h-screen flex items-center justify-center overflow-hidden">
        <div class="w-full lg:w-5/6">
            <div class="flex items-center py-6">
                ...
                <a class="transition duration-300 ease-in-out mb-2 md:mb-0 bg-green-400 px-5 py-2 text-xs shadow-sm font-small tracking-wider text-white rounded-lg hover:shadow-lg " href="{{ route('pasien-294.create') }}">Import Excel</a>
            </div>
                ...
                <table class="min-w-max w-full table-auto">
                    ...
                    <tbody class="text-gray-600 text-sm">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <form action="{{ route('pasien-294.destroy',$pasien->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="flex item-center justify-center">
                                        <button class="btn btn-primary btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data #{{ $pasien->id }}?')">
