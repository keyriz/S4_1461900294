                ...
                <div class="mt-5">
                    <form action="{{ route('dokter-294.store') }}" method="POST" class="form" enctype="multipart/form-data">
                        ...
                        <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                            <a href="{{ route('dokter-294.index') }}" class="transition duration-300 ease-in-out mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-lg hover:shadow-lg">Batal</a>
